...
namespace OnlineShoppingTeam4.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult AssignCustomers()
        {
            ...
            //if (user != null) UserManager.AddToRole(user.Id, "Guest");
        ...
        public void SendEmail(ApplicationUser user, string subject, string body)
        {
            try
            {
                ...
                mail.From = new MailAddress("OnlineShoppingDN016@gmail.com", "Online Shopping Team");
                ...
                {
                    smtp.Credentials = new System.Net.NetworkCredential("OnlineShoppingDN016@gmail.com", "Admin@123");
                    smtp.EnableSsl = true;
                    smtp.Send(mail);
                }
